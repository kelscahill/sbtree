# Old Ellicott City WordPress Theme

Old Ellicott City specific documentation to come. Old Ellicott City theme is based off of the WordPress starter theme, [Sage](https://roots.io/sage/).
...
For example, if your local development URL is `http://old-ellicott-city.dev` you would update the file to read:
```json
...
  "config": {
    "devUrl": "http://old-ellicott-city.dev"
  }
...
```
