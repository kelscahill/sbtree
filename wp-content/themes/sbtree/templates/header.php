...
?>
<div class="header-utility background--black color--brown">
  <div class="header-utility--inner layout-container">
    ...
    <div class="header-utility--right">
      <p><span class="icon icon--s"><?php get_template_part('patterns/icons/icon-clock'); ?></span>24/7 Emergency Service</p>
      <p><span class="icon icon--s"><?php get_template_part('patterns/icons/icon-phone'); ?></span>(570) 878-8183</p>
    </div>
  </div>
</div>
...
<div class="banner<?php if ($thumb_id): echo ' background-image--' . $thumb_id; endif; ?>">
